      ...
      <ul class="navbar-nav align-items-center">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{ url('locale') }}/kh">
            <img src="{{asset('public/images/flags/kh.png')}}"	class="img-flag"	alt="Khmer"	width="32" height="18">
            Khmer
          </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ url('locale') }}/en">
              <img src="{{asset('public/images/flags/en.png')}}"	class="img-flag"	alt="English"	width="32" height="18">
              English
            </a>
        </li>
        {{-- <li class="nav-item">
        ...
        {{-- <li class="nav-item dropdown dropdown-large">
          ...
          <div class="dropdown-menu dropdown-menu-end p-0">
            ...
            <div class="header-message-list p-2">
              <div class="dropdown-item bg-light radius-10 mb-1">
                ...
                <a class="dropdown-item" href="#">
                  <div class="d-flex align-items-center">
                    <img src="{{ asset('public/assets/backend') }}/images/avatars/avatar-1.png" alt="" class="rounded-circle" width="52" height="52">
              ...
              <a class="dropdown-item" href="#">
                <div class="d-flex align-items-center">
                    <img src="{{ asset('public/assets/backend') }}/images/avatars/avatar-2.png" alt="" class="rounded-circle" width="52" height="52">
                    <div class="ms-3 flex-grow-1">
              ...
              <a class="dropdown-item" href="#">
                <div class="d-flex align-items-center">
                    <img src="{{ asset('public/assets/backend') }}/images/avatars/avatar-3.png" alt="" class="rounded-circle" width="52" height="52">
                    <div class="ms-3 flex-grow-1">
              ...
              <a class="dropdown-item" href="#">
                <div class="d-flex align-items-center">
                    <img src="{{ asset('public/assets/backend') }}/images/avatars/avatar-4.png" alt="" class="rounded-circle" width="52" height="52">
                    <div class="ms-3 flex-grow-1">
              ...
              <a class="dropdown-item" href="#">
                <div class="d-flex align-items-center">
                    <img src="{{ asset('public/assets/backend') }}/images/avatars/avatar-5.png" alt="" class="rounded-circle" width="52" height="52">
                    <div class="ms-3 flex-grow-1">
              ...
              <a class="dropdown-item" href="#">
                <div class="d-flex align-items-center">
                    <img src="{{ asset('public/assets/backend') }}/images/avatars/avatar-6.png" alt="" class="rounded-circle" width="52" height="52">
                    <div class="ms-3 flex-grow-1">
        ...
        <li class="nav-item dropdown dropdown-large">
          <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">
            <div class="user-setting d-flex align-items-center gap-1">
              <img src="{{ asset('public/assets/backend') }}/images/avatars/avatar-1.png" class="user-img" alt="">
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            <li>
              <a class="dropdown-item" href="#">
                <div class="d-flex align-items-center">
                  <img src="{{ asset('public/assets/backend') }}/images/avatars/avatar-1.png" alt="" class="rounded-circle" width="60" height="60">
                  <div class="ms-3">
            ...
            <li>
              <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="setting-text ms-3"><span>{{ trans('global.logout') }}</span></div>
                </div>
              </a>
