...
@section('content')
  ...
  <div class="card">
    <div class="card-header">
      <h4 class="mb-0 text-primary"><i class="bx bxs-user me-1 font-22 text-primary"></i>{{ trans('global.list') }} {{ trans('cruds.user.title') }}
        @can($prefix.'create')
    ...
    $(document).ready(function () {
      ...
      $('body').on('click', 'a#objectEdit', function (e) {
        ...
        $.get( actionUrl +'/' +object_id+'/edit', function (res) {
          ...
          $('.single-select').val(selectRoles).trigger('change');
