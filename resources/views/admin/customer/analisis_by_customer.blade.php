  ...
  <div class="card">
    <div class="card-header">
      <h4 class="mb-0 text-primary"><i class="bx bxs-user me-1 font-22 text-primary"></i>{{ trans('cruds.customer_history.fields.treatment_history') }}>
        @can($prefix.'access')
          <a href="{{ route('admin.histories.showHistory') }}" class="btn btn-sm btn-outline-warning px-4 radius-30 float-end">
            <i class='fadeIn animated bx bx-arrow-back'></i> {{ trans('global.back') }}
          </a>
        @endcan
      </h4>
    </div>
