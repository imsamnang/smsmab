...
@section('content')
  ...
  <div class="card">
    <div class="card-header">
      <h4 class="mb-0 text-primary"><i class="bx bxs-user me-1 font-22 text-primary"></i>{{ trans('global.list') }} {{ trans('cruds.permission.title') }}
        @can($prefix.'create')
  ...
  <script>
    $(document).ready(function () {
      ...
      $('body').on('click', 'a#objectEdit', function (e) {
        ...
        modal.find('.modal-title').html('{{ trans('global.edit') }} {{ trans('cruds.permission.title_singular') }}');
